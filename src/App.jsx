...
const DATA = {
  ...
  links: {
    ...
    resume: "/M_R_Khan_CV.pdf" // place CV in public folder
  },
  summary:
...
const Chip = ({ children }) => (
  <span className="inline-block rounded-full border px-3 py-1 text-sm leading-6 mr-2 mb-2 font-[Poppins]">
    {children}
  </span>
);
...
const Nav = () => (
  <nav className="sticky top-0 z-40 bg-black/90 text-white border-b border-zinc-800">
    <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between font-[Poppins]">
      <a href="#top" className="font-extrabold text-lg">{DATA.name.split(" ")[0]}</a>
...
const Hero = () => (
  <header className="relative overflow-hidden bg-gradient-to-br from-purple-700 via-indigo-700 to-blue-700 text-white" id="top">
...
const Summary = () => (
  <Section id="summary" title="Summary">
    <p className="text-lg leading-relaxed font-[Poppins] text-zinc-200">{DATA.summary}</p>
  </Section>
);
  ...
  return (
    <div className="min-h-screen text-white font-[Poppins]">
      ...
      <footer className="border-t mt-10 border-zinc-700">
        <div className="max-w-5xl mx-auto px-4 py-8 text-sm text-zinc-400">
